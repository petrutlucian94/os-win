...
# VM snapshot types. Production checkpoints are app
# consistent, involving VSS in the process.
VM_SNAPSHOT_TYPE_DISABLED = 2
VM_SNAPSHOT_TYPE_PRODUCTION_FALLBACK = 3
VM_SNAPSHOT_TYPE_PRODUCTION_ENFORCED = 4
