...
class ProcessUtils(object):
    ...
    def assign_process_to_job_object(self, job_handle, process_handle):
        return self._run_and_check_output(kernel32.AssignProcessToJobObject,
    ...
    def kill_process_on_job_close(self, pid):
        ...
        :returns: the job handle, if a job was successfuly created and
        ...
        try:
            ...
            LOG.exception(
                "Failed to associate a job with the specified process.")
        finally:
            if process_handle:
        ...
        return job_handle if job_associated else None
