...
class ClusApiUtils(object):
    ...
    def get_cluster_node_id(self, node_handle=None):
        id_len = wintypes.DWORD(w_const.MAX_PATH)
        id_buff = (ctypes.c_wchar * id_len.value)()
        self._run_and_check_output(clusapi.GetClusterNodeId,
                                   get_cluster_node_id,
                                   id_buff,
                                   ctypes.byref(id_len))
        return id_buff.value
