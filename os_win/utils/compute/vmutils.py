...
class VMUtils(baseutils.BaseUtilsVirt):
    ...
    def _get_disk_ctrl_addr(self, controller_path):
        ...
        ctrl_paths = [rasd.path_() for rasd in scsi_ctrls]

        if controller_path in ctrl_paths:
            return ctrl_paths.index(controller_path)
    ...
    def get_disk_attachment_info(self, attached_disk_path=None, is_physical=True,
                                 serial=None):
